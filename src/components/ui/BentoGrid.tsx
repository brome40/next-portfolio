...
export const BentoGridItem = ({
  ...
  const leftSkillList:string[] = ['React.js', 'Next.js', 'TypeScript'];
  const rightSkillList:string[] = ['Styled-Components', 'Apache ECharts', 'ASP.NET MVC'];

  const [copied, setCopied] = useState<boolean>(false);

  const handleCopy = () => {
    const email:string = 'ben@romefamilyky.com';
